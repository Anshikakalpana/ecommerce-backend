...
import {} from "../models/cart/cart.js";
...
//   variantId: variantId?? undefined,
//   brand: product.brand,
//   name: validatedProduct.product.name,
//   quantity:   product.inStock ? 1 : 0,
//   unitPrice: product.price,
//   finalPrice: validatedProduct.finalPrice,
...
//   ...(validatedProduct.maxAllowedPerOrder !== undefined && { maxAllowedPerOrder: validatedProduct.maxAllowedPerOrder }),
// };
// // const result = await service.productToCart(userId, productToAdd);
// const result = await service.productToCart( productToAdd);
//     return res.status(201).json({
//       success: true,
//       message: "Product added to cart successfully",
